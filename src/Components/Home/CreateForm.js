...
const fixedInputClass =
  "rounded-md mt-2 mb-2 appearance-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm";
  ...
  return (
    <Modal isOpen={isOpen}>
      {formOpen !== "" ? (
        formOpen === "switch" ? (
          <>
            <span className="cursor-pointer" onClick={() => setForm("")}>
              back
            </span>
        ...
        <div className="flex flex-col bg-white relative">
          <div
            onClick={handleClose}
            className="absolute -right-3 -top-5 flex justify-end text-xl cursor-pointer"
          >
            x
          </div>
          <div
            onClick={() => setForm("switch")}
            className="p-3 hover:bg-gray-200 rounded-md"
          >
            Add Smart Switch
          </div>
          <div
